...
import evaka.core.application.persistence.DatabaseForm
import evaka.core.application.persistence.club.ClubFormV0
import evaka.core.application.persistence.daycare.DaycareFormV0
import evaka.core.assistanceaction.insertAssistanceActionOptionRefs
...
import evaka.core.incomestatement.insertIncomeStatement
...
import evaka.core.shared.CalendarEventAttendeeId
...
import evaka.core.shared.FamilyContactId
...
import evaka.core.shared.StaffAttendanceId
import evaka.core.shared.StaffAttendancePlanId
...
import evaka.core.shared.security.upsertMobileDeviceUser
...
INSERT INTO daycare (
    ...
    mealtime_supper, mealtime_evening_snack, with_school, nekku_order_reduction_percentage, nekku_no_weekend_meal_orders,
    service_worker_note
) VALUES (
    ...
    ${bind(row.mealtimeSupper)}, ${bind(row.mealtimeEveningSnack)}, ${bind(row.withSchool)}, ${bind(row.nekkuOrderReductionPercentage)}, ${bind(row.nekkuNoWeekendMealOrders)},
