...
import evaka.core.shared.auth.UserRole.EARLY_CHILDHOOD_EDUCATION_SECRETARY
import evaka.core.shared.auth.UserRole.FINANCE_ADMIN
import evaka.core.shared.auth.UserRole.FINANCE_STAFF
import evaka.core.shared.auth.UserRole.MESSAGING
import evaka.core.shared.auth.UserRole.REPORT_VIEWER
...
sealed interface Action {
    ...
    enum class Application(override vararg val defaultRules: ScopedActionRule<in ApplicationId>) :
        ...
        UPDATE_PLACEMENT_DRAFT(HasGlobalRole(ADMIN, SERVICE_WORKER));
