...
import evaka.core.emailclient.FromAddress
...
import evaka.core.shared.job.Nightly
            ...
            return EvakaEnv(
                ...
                forceUnpublishDocumentTemplateEnabled =
                    env.lookup("evaka.not_for_prod.force_unpublish_document_template_enabled")
                        ?: false,
                allowSfiAdmins = env.lookup("evaka.not_for_prod.allow_sfi_admins") ?: false,
    ...
    companion object {
        fun fromEnvironment(env: Environment) =
            KoskiEnv(
                ...
                syncRangeStart = env.lookup("evaka.integration.koski.sync_range_start"),
            )
    }
}
