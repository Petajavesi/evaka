...
private fun translate(action: Global) =
    action.name to
        when (action) {
            ...
            Global.SHIFT_PLANNING_PAGE -> "Työvuorosuunnittelu-sivu"
            Global.SHIFT_WISH_PAGE -> "Työvuorotoiveet-sivu"
...
private fun translate(entry: Enum<*>) =
    entry.name to
        when (entry.name) {
            ...
            "INSERT_ACL_TYOVUOROSUUNNITTELIJA" -> "Työvuorosuunnittelijan käyttöoikeuden luonti"
            "UPDATE_ACL_TYOVUOROSUUNNITTELIJA" -> "Työvuorosuunnittelijan käyttöoikeuden muokkaus"
            "UPDATE_ACL_SCHEDULED" -> "Käyttöoikeuden muokkaus (ajastettu)"
            "READ_SHIFT_PLAN" -> "Työvuorosuunnitelman luku"
            "UPDATE_SHIFT_PLAN" -> "Työvuorosuunnitelman muokkaus"
            "DOWNLOAD_SHIFT_PLAN_PDF" -> "Työvuorosuunnitelman PDF-lataus"
            "CREATE_SHIFT_WISH" -> "Työvuorotoiveen luonti"
            "UPDATE_SHIFT_WISH" -> "Työvuorotoiveen käsittely"
