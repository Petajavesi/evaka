...
export const fi = {
  ...
  header: {
    ...
    reports: 'Raportit',
    messages: 'Viestit',
    shiftPlanning: 'Työvuorosuunnittelu',
    shiftWishes: 'Työvuorot',
  ...
  applications: {
    ...
    list: {
      ...
      siblingNotFound: 'Sisaruksen tietoja ei löytynyt',
      noValidPlacement: 'Ei voimassa olevaa sijoitusta',
      startDate: 'Aloitus',
      status: 'Tila',
    ...
    childDocuments: {
      ...
      decisions: {
        ...
        otherValidDecisions: {
          ...
          description1: 'Olet tekemässä myönteisen päätöksen',
  ...
  personProfile: {
    ...
    showDetails: 'Näytä kaikki',
    hideDetails: 'Näytä vähemmän',
  ...
  roles: {
    adRoles: {
      ...
      TYOVUOROSUUNNITTELIJA: 'Työvuorosuunnittelija',
      STAFF: 'Henkilökunta',
